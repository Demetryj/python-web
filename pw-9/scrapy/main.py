...
class DataPipline:
    ...
    def close_spider(self, spider):
        with open(BASE_PATH.joinpath("quotes.json"), "w", encoding="utf-8") as fd:
            json.dump(self.quotes, fd, ensure_ascii=False, indent=2)
        with open(BASE_PATH.joinpath("authors.json"), "w", encoding="utf-8") as fd:
