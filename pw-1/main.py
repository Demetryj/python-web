...
command_map = {
    ...
    "change": (
        with_args(change_contact),
        lambda view, result: view.show_message(result),
    ),
    "phone": (
        with_args(show_phone),
        lambda view, result: view.show_contact_phones(result),
    ),
    "all": (
        without_args(show_all),
        lambda view, result: view.show_all_contacts(result),
    ),
    "add-birthday": (
        with_args(add_birthday),
        lambda view, result: view.show_message(result),
    ),
    "show-birthday": (
        with_args(show_birthday),
        lambda view, result: view.show_contact_birthday(result),
    ),
    "birthdays": (
        without_args(birthdays),
        lambda view, result: view.show_congrat_birthdays(result),
    ),
}
